...
//#region node_modules/.nitro/vite/services/ssr/assets/router-COfnrzi1.js
var router_COfnrzi1_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-5CutfiNu.css";
var APP_NAME = "VozClara";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Transcreva áudios do WhatsApp Web com a sua chave da OpenAI, Gemini, Groq ou xAI."
			},
			{
				name: "theme-color",
				content: "#0c1210"
...
var $$splitComponentImporter = () => import("./routes-WETzEdaj.mjs");
...
//#endregion
export { getRouter, router_COfnrzi1_exports as t };
