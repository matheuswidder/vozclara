...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-09pNiNEF.mjs");
...
var manifest = { "1aca9326b200150337f980e096c214c18050b73a6c43cfe9f6625561aa6366ab": {
	functionName: "transcribeAudio_createServerFn_handler",
	importer: () => import("./transcribe-ZwvjWyN8.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-COfnrzi1.mjs").then((n) => n.t),
