...
var grokOgIdentity = { "site": {
	"title": "VozClara",
	"card": "custom",
	"description": "Transcreva áudios do WhatsApp Web em texto, no próprio chat.",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_G8OsXT = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_G8OsXT
	};
	return ((_m, p) => {
		return {
			data,
